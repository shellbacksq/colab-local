...
import sys
base_dir= if sys.argv[1] else '/data02/data/pretrain_models/'
config_path = base_dir+'chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = base_dir+'chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = base_dir+'chinese_L-12_H-768_A-12/vocab.txt'
